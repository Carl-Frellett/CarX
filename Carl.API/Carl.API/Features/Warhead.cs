namespace CarX.API.Features
{
    ...
    public static class Warhead
    {
        ...
        public static AlphaWarheadNukesitePanel SitePanel
        {
            ...
            {
                if (sitePanel == null)
                    sitePanel = UnityEngine.Object.FindFirstObjectByType<AlphaWarheadNukesitePanel>();
        ...
        public static AlphaWarheadOutsitePanel OutsitePanel
        {
            get
            {
                if (outsitePanel == null)
                    outsitePanel = UnityEngine.Object.FindFirstObjectByType<AlphaWarheadOutsitePanel>();
        ...
        public static void Shake() => Controller.RpcShake();
    }
}
